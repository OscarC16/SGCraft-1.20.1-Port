...
public class SubmitNodeStorage implements SubmitNodeCollector {
    ...
    public <S> void submitModel(
        ...
        S p_434123_,
        PoseStack p_434445_,
        RenderType p_459048_,
        int p_433912_,
        int p_435238_,
        int p_433959_,
        @Nullable TextureAtlasSprite p_433439_,
        int p_435627_,
        ModelFeatureRenderer.@Nullable CrumblingOverlay p_439709_
    ) {
        this.order(0).submitModel(p_433938_, p_434123_, p_434445_, p_459048_, p_433912_, p_435238_, p_433959_, p_433439_, p_435627_, p_439709_);
    }
    ...
    public void submitModelPart(
        ...
        boolean p_440604_,
        int p_440090_,
        ModelFeatureRenderer.@Nullable CrumblingOverlay p_442784_,
        int p_451669_
    ) {
        this.order(0).submitModelPart(p_439246_, p_440594_, p_459002_, p_440257_, p_439236_, p_439406_, p_440273_, p_440604_, p_440090_, p_442784_, p_451669_);
    }
    ...
    public void submitBlockModel(
        ...
        this.order(0).submitBlockModel(p_434193_, p_458915_, p_434441_, p_433630_, p_434933_, p_434573_, p_435375_, p_435284_, p_440730_);
    }
    ...
    public void submitItem(
        ...
        RenderType p_459124_,
        ItemStackRenderState.FoilType p_440348_
    ) {
        this.order(0).submitItem(p_434225_, p_439693_, p_433159_, p_435776_, p_440725_, p_439144_, p_439266_, p_459124_, p_440348_);
    }

    @Override
    public void submitCustomGeometry(PoseStack p_435351_, RenderType p_459069_, SubmitNodeCollector.CustomGeometryRenderer p_432908_) {
        this.order(0).submitCustomGeometry(p_435351_, p_459069_, p_432908_);
    }
