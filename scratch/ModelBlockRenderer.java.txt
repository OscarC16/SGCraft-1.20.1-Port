...
public class ModelBlockRenderer {
    ...
    private void renderModelFaceAO(
        ...
        ModelBlockRenderer.AmbientOcclusionRenderStorage p_412172_,
        int p_111022_
    ) {
        for (BakedQuad bakedquad : p_111018_) {
            ...
            calculateShape(p_111013_, p_111014_, p_111015_, bakedquad, p_412172_);
    ...
    private void putQuadData(
        ...
        BakedQuad p_111029_,
        ModelBlockRenderer.CommonRenderStorage p_412412_,
        int p_111034_
    ) {
        ...
        p_111027_.putBulkData(p_111028_, p_111029_, p_412412_.brightness, f, f1, f2, 1.0F, p_412412_.lightmap, p_111034_);
    }

    private static void calculateShape(
        BlockAndTintGetter p_111040_, BlockState p_111041_, BlockPos p_111042_, BakedQuad p_470839_, ModelBlockRenderer.CommonRenderStorage p_412438_
    ) {
        float f = 32.0F;
        float f1 = 32.0F;
        float f2 = 32.0F;
        ...
        for (int i = 0; i < 4; i++) {
            Vector3fc vector3fc = p_470839_.position(i);
        ...
        if (p_412438_ instanceof ModelBlockRenderer.AmbientOcclusionRenderStorage modelblockrenderer$ambientocclusionrenderstorage) {
        ...
        p_412438_.facePartial = switch (p_470839_.direction()) {
        ...
        p_412438_.faceCubic = switch (p_470839_.direction()) {
    ...
    private void renderModelQuadFlat(
        ...
        {
            if (p_111007_) {
                calculateShape(p_111002_, p_111003_, p_111004_, bakedquad, p_412163_);
    ...
    public static enum AdjacencyInfo {
        ...
        private AdjacencyInfo(
            ...
            float p_111123_,
            boolean p_111124_,
            ModelBlockRenderer.SizeInfo[] p_111125_,
            ModelBlockRenderer.SizeInfo[] p_111126_,
            ModelBlockRenderer.SizeInfo[] p_111127_,
            ModelBlockRenderer.SizeInfo[] p_111128_
        ) {
    ...
    public static class AmbientOcclusionRenderStorage extends ModelBlockRenderer.CommonRenderStorage {
        ...
        public void calculate(BlockAndTintGetter p_412286_, BlockState p_412102_, BlockPos p_412730_, Direction p_412336_, boolean p_412430_) {
            ...
            BlockState blockstate = p_412286_.getBlockState(blockpos$mutableblockpos);
            int i = this.cache.getLightColor(blockstate, p_412286_, blockpos$mutableblockpos);
            float f = this.cache.getShadeBrightness(blockstate, p_412286_, blockpos$mutableblockpos);
            blockpos$mutableblockpos.setWithOffset(blockpos, modelblockrenderer$adjacencyinfo.corners[1]);
            BlockState blockstate1 = p_412286_.getBlockState(blockpos$mutableblockpos);
            int j = this.cache.getLightColor(blockstate1, p_412286_, blockpos$mutableblockpos);
            float f1 = this.cache.getShadeBrightness(blockstate1, p_412286_, blockpos$mutableblockpos);
            blockpos$mutableblockpos.setWithOffset(blockpos, modelblockrenderer$adjacencyinfo.corners[2]);
            BlockState blockstate2 = p_412286_.getBlockState(blockpos$mutableblockpos);
            int k = this.cache.getLightColor(blockstate2, p_412286_, blockpos$mutableblockpos);
            float f2 = this.cache.getShadeBrightness(blockstate2, p_412286_, blockpos$mutableblockpos);
            blockpos$mutableblockpos.setWithOffset(blockpos, modelblockrenderer$adjacencyinfo.corners[3]);
            BlockState blockstate3 = p_412286_.getBlockState(blockpos$mutableblockpos);
            ...
            if (!flag2 && !flag) {
                ...
                BlockState blockstate8 = p_412286_.getBlockState(blockpos$mutableblockpos);
                f4 = this.cache.getShadeBrightness(blockstate8, p_412286_, blockpos$mutableblockpos);
                i1 = this.cache.getLightColor(blockstate8, p_412286_, blockpos$mutableblockpos);
            }
            ...
            if (!flag3 && !flag) {
                ...
                BlockState blockstate10 = p_412286_.getBlockState(blockpos$mutableblockpos);
                f5 = this.cache.getShadeBrightness(blockstate10, p_412286_, blockpos$mutableblockpos);
                j1 = this.cache.getLightColor(blockstate10, p_412286_, blockpos$mutableblockpos);
            }
            ...
            if (!flag2 && !flag1) {
                ...
                BlockState blockstate11 = p_412286_.getBlockState(blockpos$mutableblockpos);
                f6 = this.cache.getShadeBrightness(blockstate11, p_412286_, blockpos$mutableblockpos);
                k1 = this.cache.getLightColor(blockstate11, p_412286_, blockpos$mutableblockpos);
            }
            ...
            if (!flag3 && !flag1) {
                ...
                BlockState blockstate12 = p_412286_.getBlockState(blockpos$mutableblockpos);
                f7 = this.cache.getShadeBrightness(blockstate12, p_412286_, blockpos$mutableblockpos);
                l1 = this.cache.getLightColor(blockstate12, p_412286_, blockpos$mutableblockpos);
            }

            int i3 = this.cache.getLightColor(p_412102_, p_412286_, p_412730_);
            blockpos$mutableblockpos.setWithOffset(p_412730_, p_412336_);
            BlockState blockstate9 = p_412286_.getBlockState(blockpos$mutableblockpos);
            if (this.faceCubic || !blockstate9.isSolidRender()) {
                i3 = this.cache.getLightColor(blockstate9, p_412286_, blockpos$mutableblockpos);
            }

            float f8 = this.faceCubic
                ? this.cache.getShadeBrightness(p_412286_.getBlockState(blockpos), p_412286_, blockpos)
                : this.cache.getShadeBrightness(p_412286_.getBlockState(p_412730_), p_412286_, p_412730_);
            ModelBlockRenderer.AmbientVertexRemap modelblockrenderer$ambientvertexremap = ModelBlockRenderer.AmbientVertexRemap.fromFacing(p_412336_);
        ...
        private static int blend(int p_412676_, int p_412469_, int p_412736_, int p_412253_) {
            ...
            return p_412676_ + p_412469_ + p_412736_ + p_412253_ >> 2 & 16711935;
        }
        ...
        protected static int blend(int p_412759_, int p_412518_, int p_412118_, int p_412415_, float p_412783_, float p_412051_, float p_412530_, float p_412587_) {
            int i = (int)(
                    (p_412759_ >> 16 & 0xFF) * p_412783_
                        + (p_412518_ >> 16 & 0xFF) * p_412051_
                        + (p_412118_ >> 16 & 0xFF) * p_412530_
                        + (p_412415_ >> 16 & 0xFF) * p_412587_
                )
                & 0xFF;
            int j = (int)((p_412759_ & 0xFF) * p_412783_ + (p_412518_ & 0xFF) * p_412051_ + (p_412118_ & 0xFF) * p_412530_ + (p_412415_ & 0xFF) * p_412587_)
                & 0xFF;
            return i << 16 | j;
        }
    }
    ...
    public static class Cache {
        ...
        public int getLightColor(BlockState p_111222_, BlockAndTintGetter p_111223_, BlockPos p_111224_) {
            return LevelRenderer.getLightColor(
                this.enabled ? this.cachedBrightnessGetter : LevelRenderer.BrightnessGetter.DEFAULT, p_111223_, p_111222_, p_111224_
            );
        }
