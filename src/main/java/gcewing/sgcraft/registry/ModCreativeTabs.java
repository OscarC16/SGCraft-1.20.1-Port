...
public class ModCreativeTabs {
    ...
    public static final RegistryObject<CreativeModeTab> SGCRAFT_TAB = CREATIVE_MODE_TABS.register("sgcraft_tab",
            () -> CreativeModeTab.builder()
                    .title(Component.translatable("itemGroup.sgcraft"))
                    .icon(() -> new ItemStack(ModItems.NAQUADAH_INGOT.get())) // Usamos Naquadah Ingot como icono temporal
